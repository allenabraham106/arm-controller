...
static const _WaypointCommand_type_support_symbol_names_t _WaypointCommand_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, arm_controller, msg, WaypointCommand)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, arm_controller, msg, WaypointCommand)),
  }
};
...
{
  return &::arm_controller::msg::rosidl_typesupport_cpp::WaypointCommand_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, arm_controller, msg, WaypointCommand)() {
  return get_message_type_support_handle<arm_controller::msg::WaypointCommand>();
}
